  ...
  return (
    <View style={{
      ...
      <Text style={{
        ...
        textAlign: 'center',
        lineHeight: 22,
      }}>Before creating your trip, review your selections</Text>
        ...
        <View style={{
          ...
          <View>
            ...
            <Text style={{
              ...
              color: '#1A1A1A',
              marginTop: 2,
            }}>{tripData.locationInfo?.name?.split(',')[0]}</Text>
            <Text style={{
              fontFamily: 'outfit-medium',
              fontSize: 16,
              color: '#4B9CD3',
              marginTop: 4,
            }}>{tripData.locationInfo?.name?.split(',').slice(1).join(', ').trim()}</Text>
          </View>
        </View>
