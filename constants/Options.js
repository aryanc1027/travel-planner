...
export const AI_Prompt =
  'Generate Travel Plan for Location: {location}, departing from {departureAirport} ({departureIATA}), for {totalDays} Days and {totalNights} Nights for a {traveler} with {budget} budget with flight details, Flight Price with Booking URL, Hotels options list with HotelName, Hotel Address, Price, hotel image url, geo coordinates, rating, description, and Places to visit nearby with placeName, Place Details, Place Image Url, Geo Coordinates, ticket Pricing, Timing to travel each of the locations for {totalDays} day and {totalNights} night with each day plan with best time to visit in JSON format. Provide only actual details and real information - do not include any example text, placeholder text, hypothetical scenarios, or phrases like "check actual flights". All information must be current and real.';
